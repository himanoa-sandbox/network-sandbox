...
rust_library(
    ...
    srcs = glob(["**/*.rs"]),
    deps = [
        "@complicated_cargo_library__aho_corasick__0_6_10//:aho_corasick",
        "@complicated_cargo_library__memchr__2_2_1//:memchr",
        "@complicated_cargo_library__regex_syntax__0_5_6//:regex_syntax",
        "@complicated_cargo_library__thread_local__0_3_6//:thread_local",
        "@complicated_cargo_library__utf8_ranges__1_0_4//:utf8_ranges",
    ],
    rustc_flags = [
        "--cap-lints=allow",
    ],
