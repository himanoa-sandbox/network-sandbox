...
rust_library(
    ...
    srcs = glob(["**/*.rs"]),
    deps = [
        "@complicated_cargo_library__arrayvec__0_4_12//:arrayvec",
        "@complicated_cargo_library__cfg_if__0_1_10//:cfg_if",
        ...
        "@complicated_cargo_library__memoffset__0_5_1//:memoffset",
        "@complicated_cargo_library__scopeguard__1_0_0//:scopeguard",
    ],
    rustc_flags = [
        "--cap-lints=allow",
    ],
