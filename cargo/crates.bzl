...
def complicated_cargo_library_fetch_remote_crates():
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:MacTypes-sys-2.1.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:aho-corasick-0.6.10.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:arrayvec-0.3.25.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:arrayvec-0.4.12.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:atom-0.3.5.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:cfg-if-0.1.10.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:core-foundation-sys-0.5.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:crossbeam-0.3.2.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:crossbeam-deque-0.7.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:crossbeam-epoch-0.7.2.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:crossbeam-queue-0.1.2.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:crossbeam-utils-0.6.6.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:derivative-1.0.3.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:fnv-1.0.6.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:hibitset-0.3.2.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:lazy_static-1.4.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:libc-0.2.65.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:memchr-2.2.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:memoffset-0.5.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:mopa-0.2.2.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:nodrop-0.1.14.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:num_cpus-1.10.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:odds-0.2.26.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:proc-macro2-0.4.30.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:pulse-0.5.3.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:quote-0.3.15.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:quote-0.6.13.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:rayon-0.8.2.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:rayon-core-1.6.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:redox_syscall-0.1.56.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:regex-0.2.11.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:regex-syntax-0.5.6.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:rustc_version-0.2.3.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:scopeguard-1.0.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:security-framework-sys-0.2.3.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:semver-0.9.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:semver-parser-0.7.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:shred-0.5.2.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:shred-derive-0.3.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:smallvec-0.4.5.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:specs-0.10.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:syn-0.11.11.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:syn-0.15.44.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:synom-0.11.3.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:thread_local-0.3.6.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:time-0.1.42.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:tuple_utils-0.2.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:ucd-util-0.1.5.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:unicode-xid-0.0.4.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:unicode-xid-0.1.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:utf8-ranges-1.0.4.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:winapi-0.3.8.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:winapi-i686-pc-windows-gnu-0.4.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:winapi-x86_64-pc-windows-gnu-0.4.0.BUILD")
    )
